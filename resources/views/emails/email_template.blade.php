				...
				<tr>
					<td style=" padding:10px 15px;">
					    <a href="<?php echo url('/'); ?>" style="color:#FFFFFF; text-decoration: none;">
							<img src="<?php echo url('/'); ?>/front_images/Bubblebath.png" alt="img" width="75px">
                        </a>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td align="center" style="background-color:#f09922; text-align:center; padding:15px 10px 10px 10px;">
						<table style="margin:0 auto;">
							<tr>
                                <td style="color:#fff;">
              						&copy; Copyright All Rights Reserved, <a href="/" style="color:#fff;text-decoration: none;" ><?php echo Session::get('titan.settings.name'); ?></a> <?php echo date('Y'). '.'; ?> 
								</td>
							</tr>
                        </table>
					</td>
