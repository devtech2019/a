...
<!-- inner content -->
  @section('inner_content')
    ...
    <div id="home-slider" class="home-slider">
      <div class="item home-slider-bg" style="background-image: url('public/images/slider-1.jpg')">
        <div class="container">
      ...
      <div class="item home-slider-bg" style="background-image: url('public/images/slider-2.jpg')">
        <div class="container">
          <div class="slider-dtl">
            <h4 class="slider-sub-heading">We Care</h4>
            <h1 class="slider-heading">For Your Car</h1>
      ...
      <div class="item home-slider-bg" style="background-image: url('public/images/slider-3.jpg')">
        <div class="container">
          <div class="slider-dtl">
            <h4 class="slider-sub-heading">We Care</h4>
            <h1 class="slider-heading">For Your Car</h1>
        ...
        <div class="row">
          ...
          <div class="col-md-4 hidden-sm">
            <div class="who-we-are-img">
              <img src="public/images/who-we-are.jpg" class="img-responsive" alt="who-we-are">
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="col-md-3 col-sm-6">
                <div class="service-block text-center">
                  <div class="service-icon">
                    <a href="#"><img src="{{asset('public/images/services')}}/{{$service->icon}}" class="img-responsive" alt="service-01"></a>
                  </div>
            ...
            @if ($galleries)
              @foreach ($galleries as $gallery)
                <div class="item work-gallery-block">
                  <img src="{{asset('public/images/gallery')}}/{{$gallery->gallery_img}}" class="img-responsive" alt="gallery">
                  <div class="overlay-bg"><a href="{{asset('public/images/gallery')}}/{{$gallery->gallery_img}}" title="Your Image Title"><i class="fa fa-plus"></i></a></div>
                </div>
              @endforeach
            @endif
          </div>
              ...
              @if ($team->status == 'A' ? true : false)
                <div class="col-md-3 col-sm-6">
                  <div class="team-block text-center">
                    <div class="team-img">
                      <a href="#"><img src="{{asset('public/images/teams')}}/{{$team->photo}}" class="img-responsive" alt="team">
  ...
  <!--  testimonials -->
    <div id="testimonials" class="testimonials-main-block">
      <div class="parallax" style="background-image: url('public/images/bg/testimonials-bg.jpg')">
      <div class="overlay-bg"></div>
        <div class="container">
          <div class="section text-center">
                ...
                <div class="item testimonials-block">
                  ...
                  <div class="testimonials-client">
                    <div class="testimonials-client-img">
                      <img src="{{asset('public/images/testimonial')}}/{{$testimonial->image}}" class="img-responsive" alt="client-01">
                    </div>
        ...
        <div class="row">
          <div class="col-md-4 hidden-sm">
            <div class="appointment-img">
              <img src="public/images/appointment.jpg" class="img-responsive" alt="Appointment">
            </div>
          </div>
            ...
            @foreach ($blogs as $blog)
              <div class="col-md-4 col-sm-6">
                <div class="news-block">
                  <div class="news-img">
                    <a href="#"><img src="{{asset('public/images/blog')}}/{{$blog->img}}" class="img-responsive" alt="news">
                      <div class="overlay-bg"></div>
                    </a>
                  </div>
                  <div class="news-top">
          ...
          @if ($clients)
            @foreach ($clients as $client)
              <div class="item client-img">
                <img src="{{asset('public/images/clients')}}/{{$client->image}}" class="img-responsive" alt="client-1">
              </div>
            @endforeach
          @endif
        </div>
