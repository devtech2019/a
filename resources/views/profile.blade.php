  ...
  <div class="box-body profile-card">
    <div class="box box-widget widget-user">
      ...
      <div class="widget-user-image">
        <img src="{{asset('public/images/users')}}/{{Auth::user()->photo}}" class="img-responsive img-circle" alt="Profile">
      </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-4 border-right">
            <div class="description-block">
              ...
              <span class="description-text"><a href="{{route('admin.users.edit', Auth::user()->id)}}" class="btn btn-sm btn-info">Edit</a></span>
            </div>
            <!-- /.description-block -->
          </div>
