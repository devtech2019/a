              ...
              "ajax": {
                  ...
                  {data  : 'mobile' },
                  {
                      ...
                      "render"        : function(result){
                          ...
                          var deleteUrl           =   adminUserListUrl+'/delete-users/'+franchiseId;
                          var dropDownButton      =   ''+

                          '<div class="btn-toolbarr">'+

                              '<a href="'+adminUserListUrl+'/edit/'+franchiseId+'" class="btn btn-info btn-sm mr-1" data-toggle="tooltip" title="" data-original-title="Edit '+name+'">'+
