...
@section('content')
 ...
 <div class="box-body">
     <div class="box-body">
        <a href="{{ route('vehicle_modal.create') }}" class="btn btn-default btn-add" data-toggle="modal" data-target="">Create Vehicle Modal</a>
      </div>
                    ...
                    <div class="col-md-5">
                         <div class="form-group">
                            ...
                            <div class="input-group displayblock">
                                <input type="text" name="vehicle_modal" class="form-control" id="column_filter_1"  onkeyup="searchDatatable(1)" placeholder="Enter vehicle modal">
                            </div>
                        </div>
                    </div>     
                  <!--   <div class="col-md-5">
        ...
        dataTable   =    $('#dataShowTable').DataTable({
            ...
            "ajax": {
                ...
                dataSrc :   function(res){
                    if(res){
                       try{
                            Sreq                =   res.sreq;
                            vehicleCompanies    =   res.vehicle_companies;
                            return res.data;
                        } catch(e) {
                            return [];
                        } 
            ...
            "columns": [
...

                {
                    ...
                    "render"        : function(vehicle_company_id){
                       return "<div id='dvNotes' class='wordwrap'>" + vehicleCompanies[vehicle_company_id] + "</div>" ;
                    }
                },
                {
                    "data"          : 'vehicle_modal',
                    "render"        : function(vehicle_modal){
                       return "<div id='dvNotes' class='wordwrap'>" +vehicle_modal+ "</div>" ;
                    }
                },
...

                {
                    ...
                    "render"        : function(result){
                        ...
                        var adminListUrl        =   "{{$adminListUrl}}";
                         var deleteUrl           =   adminListUrl+'/delete-vehicle_modal/'+id;
