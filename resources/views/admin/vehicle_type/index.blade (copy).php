...
@section('content')
  <div class="box-body">
    <button type="button" class="btn btn-default btn-add" data-toggle="modal" data-target="#create_vehicle_type">Add Vehicle class</button>
  </div>
  <!-- Create Modal -->
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Create Vehicle Class</h4>
        </div>
          ...
          <div class="modal-body">
            <div class="row">
              ...
              <div class="form-group{{ $errors->has('type') ? ' has-error' : '' }} col-md-6">
                ...
                {!! Form::text('type', null, ['class' => 'form-control', 'required' => 'required', 'placeholder'=>'Vehicle Class']) !!}
