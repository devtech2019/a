...
<div class="box-body">
        <form id="searchForm"  action="{{route('team.index')}}" role="search" name="searchForm" type="post" >
            <div class="row">
                <div class="col-md-4">
                     <div class="form-group">
                        <label for="Name">Name</label>
                        <div class="input-group displayblock">
                            <input type="text" name="name" class="form-control" value="{{$input['name'] ?? ''}}" placeholder="Enter name">
                        </div>
                    </div>
                </div>     
                <div class="col-md-4">
                ...
                <div class="col-md-2">
                     <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <?php echo '&nbsp;' ?>
                            <a href="/admin/team" class="btn btn-primary">Reset</a>
      ...
      @if ($teams)
        ...
        @foreach ($teams as $team)
          ...
          <tr>
            ...
            <td><img width="80px" height="80px" src="{{asset('public/images/teams/')}}/{{$team->photo}}" alt="" class="img-responsive"></td>
            <td>{{$team->name}}</td>
            <td>{{$team->email}}</td>
            <td  style="width:15%">{{$team->dob}}</td>
            <td style="width:20%">{{$team->mobile}}</td>
                ...
                <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      {!! Form::open(['method' => 'POST', 'action' => 'AdminTeamSocialController@store']) !!}
                        <div class="row">
                          <div class="col-md-4">
                            ...
                            <div class="form-group{{ $errors->has('url') ? ' has-error' : '' }}">
                              {!! Form::label('url', 'Social URL') !!}
                              {!! Form::text('url', null, ['class' => 'form-control','pattern'=>"https://.*" ,'size'=>"30", 'required' => 'required', 'placeholder'=>'social url']) !!}
                              <small class="text-danger">{{ $errors->first('url') }}</small>
                            </div>
                          </div>
                          <div class="col-md-4">
                      ...
                      <div class="modal-footer">
                        <div class="btn-group pull-right">
                          {!! Form::reset("Reset", ['class' => 'btn btn-default btn-yellow', 'data-dismiss'=>'modal' ]) !!}
            ...
            <td>
             ...
             <td>
              ...
              <!-- edit button -->
              <a href="{{route('franchise_cleaner.index',[$team->id])}}" class="btn btn-info btn-sm">Cleaners</a>
              ...
              <div id="{{$team->id}}deleteModal" class="delete-modal modal fade" role="dialog">
                <div class="modal-dialog modal-sm">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                      <h4 class="modal-heading">Are You Sure ?</h4>
                      <p>Do you really want to delete this franchise? </p>
                    </div>
                    <div class="modal-footer">
