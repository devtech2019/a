      ...
      <div class="row">
        <div class="col-md-3">
          <div class="user-img-block">
            <img src="{{asset('public/images/teams')}}/{{$team->photo}}" alt="" class="img-responsive img-thumbnail">
          </div>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3">
          ...
          <div class="form-group{{ $errors->has('dob') ? ' has-error' : '' }}">
            ...
            {!! Form::text('dob', null, ['class' => 'form-control ', 'required' => 'required', 'placeholder'=>'Foundation Date','readonly' ]) !!}
          ...
          <div class="form-group{{ $errors->has('join_date') ? ' has-error' : '' }}">
            ...
            {!! Form::text('join_date', null, ['class' => 'form-control ', 'placeholder'=>'Join Date','readonly']) !!}
