                            ...
                            <div class="d-flex">
                                ...
                                <div class="float-right">
                                    <div class="dt-table text-right mb-1" data-server="true">
                                        <div class="btn-group">
                                            <a href="{{ "sections/content/{$item->id}/edit" }}" class="btn btn-primary btn-xs" data-toggle="tooltip" title="Edit {{ $item->heading }}">
                                                <i class="fa fa-fw fa-edit"></i>
                                            </a>
                                        </div>

                                        <div class="btn-group">
                                            <form id="form-delete-row{{ $item->id }}" method="POST" action="{{ "sections/{$item->id}" }}">
