...
<div class="box-header">
  ...
  {!! Form::model( $item, ['method' => 'POST', 'action' => ['PagesController@update',  $item->id], 'files' => true]) !!}
    {!! csrf_field() !!}
       ...
       <div class="col-12 col-md-6">
           ...
           <div class="col-12 col-md-6">
              <div class="form-group {{ $errors->has('video_url') ? ' has-error' : '' }}">
                 ...
                 <input type="text" class="form-control" id="video_url" name="video_url" placeholder="Enter Video Url"   value="{{ ($errors && $errors->any()? old('video_url') : (isset($item)? $item->video_url : '')) }}"> 
                    <div class="input-group-append">
                        <span class="input-group-text"><i class="fas fa-link"></i></span>
                    </div>
