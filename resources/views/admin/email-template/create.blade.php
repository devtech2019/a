...
@section('sidebar_active')
  @include('include.sidebar_links', [
    ...
    'emailtemplate' => 'active','all_email_template'=>'','all_create_email_template'=>'active','emailManagement' => 'active',
...
<div class="box-header">
  {!! Form::open(['method' => 'POST', 'action' => 'AdminEmailTemplateController@saveTemplate', 'files' => true]) !!} {!! csrf_field() !!}
  ...
  <div class="box-footer">
     <div class="btn-group pull-left"> 
        {!! Form::reset("Reset", ['class' => 'btn btn-yellow btn-default']) !!} {!! Form::submit("Create", ['class' => 'btn btn-add btn-default']) !!} 
     </div>
  </div>
</div>
