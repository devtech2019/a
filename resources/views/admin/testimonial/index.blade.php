        ...
        @if ($testimonials)
          ...
          @foreach ($testimonials as $testimonial)
            <tr>
              ...
              <td><img width="50px" height="50px" src="{{asset('public/images/testimonial')}}/{{$testimonial->image}}" class="img-responsive" alt=""></td>
              <td style="white-space: normal;word-break: break-all;">{{$testimonial->name}}</td>
              <td style="white-space: normal;word-break: break-all;">{{$testimonial->post}}</td>
              <td title="{{$testimonial->detail}}" style="white-space: normal;word-break: break-all;">{{str_limit($testimonial->detail, 50)}}</td>
