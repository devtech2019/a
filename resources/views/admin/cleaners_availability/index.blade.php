        ...
        <div class="row">
            <div class="col-md-5">
                    ...
                    <div class="input-group displayblock">
                        <input type="text" name="coupon_code" class="form-control " id="column_filter_1"  onkeyup="searchDatatable(1)" placeholder="Enter Coupon Code">
                    </div>
                </div>
            </div>     
            <div class="col-md-5">
                    ...
                    <div class="input-group displayblock">
                        <input type="text" name="title" class="form-control " id="column_filter_2"  onkeyup="searchDatatable(2)" placeholder="Enter title">                             
                    </div>
                </div>
            </div>   
            <div class="col-md-2">
