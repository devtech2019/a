...
@section('content')
    ...
    <form class="card card-primary" method="POST" action="{{ADMIN_URL}}pages/{{ $page->id . '/sections/content' . (isset($item)? "/{$item->id}" : '')}}" accept-charset="UTF-8" enctype="multipart/form-data">
        {!! csrf_field() !!}
    ...
    <script type="text/javascript" charset="utf-8">
        $(function () {
            ...
            $('.btn-delete-media').on('click', function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: ADMIN_URL+"pages/" + $page_id + "/sections/content/" + $id + "/removeMedia",
                    dataType: "json",
