        ...
        <div class="row">
            <div class="col-md-5">
                    ...
                    <div class="input-group displayblock">
                        <input type="text" name="name" class="form-control " id="column_filter_1"  onkeyup="searchDatatable(1)" placeholder="Enter page name">
                    </div>
                </div>
            </div>     
           <!--  <div class="col-md-5">
             ...
             "columns": [
                ...
                
                {
                    ...
                    "render"        : function(result){
                        ...
                        var deleteUrl           =   adminListUrl+'/delete-cms/'+id;
                        var dropDownButton      =   ''+
                                  ...
                                  '<div class="modal-dialog modal-sm">'+
                                    '<div class="modal-content">'+
                                      ...
                                      '<div class="modal-body text-center">'+
                                        ...
                                        '<p>Do you really want to delete these page?</p>'+
                                      '</div>'+
