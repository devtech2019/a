            ...
            <table id="tbl-list" data-page-length="25" class="dt-table table table-sm table-bordered table-striped table-hover">
                ...
                @foreach ($items as $item)
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="{{ADMIN_URL}}pages/{{ $item->id }}/sections" class="btn btn-info btn-xs" data-toggle="tooltip" title="Manage Page Content">
                                    <i class="far fa-fw fa-file-alt"></i>
                                </a>
                            </div>
                            {!! action_row(WEBSITE_ADMIN_NAV_URL.$selectedNavigation->url, $item->id, $item->name, ['edit', 'delete'], false) !!}
                        </td>
                    </tr>
                @endforeach
                </tbody>
