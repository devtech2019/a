            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group{{ $errors->has('vehicle_type_id') ? ' has-error' : '' }}">
                  ...
                  {!! Form::select('vehicle_type_id', array(''=>'Choose Vehicle Type') + $vehicle_types, null, ['class' => 'form-control select2']) !!}
                ...
                <div class="form-group{{ $errors->has('washing_plan_id') ? ' has-error' : '' }}">
                  ...
                  {!! Form::select('washing_plan_id', array(''=>'Choose Plan') + $washing_plans, null, ['class' => 'form-control select2']) !!}
              ...
              <div class="col-md-6">
                ...
                <div class="form-group{{ $errors->has('duration') ? ' has-error' : '' }}">
                  ...
                  {!! Form::text('duration', null, ['class' => 'form-control', 'placeholder'=>'Enter Plan Duration']) !!}
