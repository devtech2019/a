        ...
        {!! Form::open(['method' => 'POST', 'action' => 'AdminWashingPlanController@store']) !!}
          <div class="modal-body">
            ...
            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                ...
                {!! Form::textarea('description', null, ['class' => 'form-control', 'required' => 'required', 'placeholder'=>'Enter Plan Description','row'=>'4']) !!}
          ...
          @foreach ($washing_plans as $washing_plan)
            <tr>
              ...
              <td style ="word-break: break-all; 
                     white-space: normal;">{!!nl2br($washing_plan->name)!!}</td>
              <td>
                              ...
                              @foreach ($washing_includes as $washing_include)
                                @if ($washing_include->washing_plan_id == $washing_plan->id)
                                  <tr>
                                    ...
                                    <td style ="word-break: break-all; 
                     white-space: normal;">{{$washing_include->washing_plan_include}}</td>
                                    <!-- <td style ="word-break: break-all; 
                     white-space: normal;">{{$washing_include->washing_plan_include}}</td> -->

                                    <!-- <td>{{chunk_split($washing_include->washing_plan_include, 10)}}</td> -->
                                        ...
                                        <div class="modal-dialog modal-sm">
                                          ...
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-body text-center">
                                              ...
                                              <p>Do you really want to delete these washing plan services?</p>
                                            </div>
                                            <div class="modal-footer">
                        ...
                        <div class="form-group{{ $errors->has('washing_plan_include') ? ' has-error' : '' }}">
                            {!! Form::label('washing_plan_include', 'Service Add') !!}
