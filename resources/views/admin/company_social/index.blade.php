        ...
        {!! Form::open(['method' => 'POST', 'action' => 'AdminCompanySocialController@store']) !!}
          <div class="modal-body">
            <div class="form-group{{ $errors->has('link') ? ' has-error' : '' }}">
              ...
              {!! Form::text('link', null, ['class' => 'form-control','placeholder'=>'social url']) !!}
              
              <small class="text-danger">{{ $errors->first('link') }}</small>
            </div>
            <div class="form-group{{ $errors->has('social_site') ? ' has-error' : '' }}">
              {!! Form::label('social_site', 'Social Site') !!}
              {!! Form::select('social_site', [""=>"Social Networks", "Facebook"=>"Facebook", "Instagram"=>"Instagram", "Twitter"=>"Twitter", "Google"=>"Google", "Pinterest"=>"Pinterest", "You Tube"=>"You Tube", "Tumblr"=>"Tumblr", "Dribbble"=>'Dribbble', "Flickr"=>"Flickr", "Github"=>"Github", "Linkedin"=>"Linkedin", "Skype"=>"Skype"], null, ['class' => 'form-control select2']) !!}
              <small class="text-danger">{{ $errors->first('social_site') }}</small>
            </div>
            <div class="form-group{{ $errors->has('social_icon') ? ' has-error' : '' }}">
              {!! Form::label('social_icon', 'Social Icons') !!}
              {!! Form::text('social_icon', null, ['class' => 'form-control social-icon-picker', 'placeholder'=>'Choose social icon']) !!}
              <small class="text-danger">{{ $errors->first('social_icon') }}</small>
            </div>
          </div>
