...
@section('sidebar_active')
  @include('include.sidebar_links', [
    ...
    'notification' => 'active','all_notification'=>'active','create_notification'=>''
  ])
@endsection

@section('breadcum')
  @include('include.breadcum', [
    'title' => 'Edit Push Notifications',
    'from' => 'Admin',
    'to' => 'Edit Push Notifications',
  ])
@endsection
...
@section('content')
 <div class="box-header">
   ...
   {!! Form::model($item, ['method' => 'POST', 'action' => ['AdminPushNotificationController@updateTemplate', $item->id], 'files' => true]) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            {!! Form::label('action', 'Action') !!}
                               {!! Form::select('action', $actionOptions, null, ['class' => 'form-control', 'id'=>'action', ]) !!}
