...
@section('breadcum')
  @include('include.breadcum', [
    'title' => 'My Cleaners Daily Ride ',
    'from' => 'Admin',
    'to' => 'My Cleaners Daily Ride',
  ])
@endsection
                ...
                { 
                    ...
                    render  : function(data){
                        if(data != null) {
                            ...
                            var result = checkFileExist("{{config('app.WEBSITE_URL')}}/public/images/daily_photo/"+data);
                            if (result == true) {
                                return  '<img src="{{config('app.url')}}/public/images/daily_photo/'+data+'"  width="100" height="100" class="km-image"/>'
                            } else {
