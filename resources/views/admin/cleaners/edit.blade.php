...
@section('content')
  ...
  {!! Form::model($user, ['method' => 'PATCH', 'action' => ['AdminCleanerController@update', $user->id], 'files' => true]) !!}
    <div class="box-body">
      <div class="row">
        <div class="col-md-3">
        ...
        <div class="col-md-3">
          ...
          <div class="form-group{{ $errors->has('dob') ? ' has-error' : '' }}">
           ...
           {!! Form::text('zip_code', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => 'Enter your zip_code', 'autofocus']) !!}
        ...
        <div class="col-md-3">
          ...
          <div class="radio{{ $errors->has('sex') ? ' has-error' : '' }} user-create-radio" style="margin-left:90%; position: relative;bottom: 95px">
            <span>Gender</span>
        ...
        <div class="col-md-3">
          @if (Auth::user()->role == 'A')
            <div class="form-group{{ $errors->has('role') ? ' has-error' : '' }}">
              ...
              {!! Form::select('role', [""=>"Choose Role", "A"=>"administrator", "S"=>"subscriber","C"=>"cleaner"], null, ['class' => 'form-control','id'=>'roles']) !!}
              <small class="text-danger">{{ $errors->first('role') }}</small>
            </div>
          @endif
            <div class="col-md-8" id="hidden">
          <div class="form-group{{ $errors->has('id') ? ' has-error' : '' }}">
            {!! Form::label('Franchisee', 'Franchisee') !!}
           
            {!! Form::select('id', [""=>$franchiseList], null, ['class' => 'form-control ','id'=>'hidden', 'required' => 'required']) !!}
