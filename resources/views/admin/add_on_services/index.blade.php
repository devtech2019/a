...
@section('sidebar_active')
  @include('include.sidebar_links', [
    ...
    'profile' => '', 'sub_appointment' => '','add_on_services' => 'active','create_add_on_services'=>'' 
  ])
@endsection
...
<script>
    ...
    $(document).ready(function() {
        ...
        dataTable   =    $('#dataShowTable').DataTable({
            ...
            "ajax": {
                async   :   true,
                "url"   :   "{{route('add_on_services.index')}}",
             ...
             "columns": [
               ...
               
                {
                    ...
                    "render"        : function(result){
                        ...
                        var deleteUrl           =   adminListUrl+'/delete-add_on_services/'+id;
                        var dropDownButton      =   ''+
                                  ...
                                  '<div class="modal-dialog modal-sm">'+
                                    '<div class="modal-content">'+
                                      ...
                                      '<div class="modal-body text-center">'+
                                        ...
                                        '<p>Do you really want to delete this addon service?</p>'+
                                      '</div>'+
