        ...
        <div class="row">
            <div class="col-md-5">
                    ...
                    <div class="input-group displayblock">
                        <input type="text" name="payment_id" class="form-control " id="column_filter_0"  onkeyup="searchDatatable(0)" placeholder="Enter payment">
                    </div>
                </div>
            </div>     
            <div class="col-md-5">
                    ...
                    <div class="input-group displayblock">
                        <input type="email" name="email" class="form-control " id="column_filter_2"  onkeyup="searchDatatable(2)" placeholder="Enter email">                             
                    </div>
                </div>
            </div>   
            <div class="col-md-2">
