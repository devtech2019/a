...
@section('sidebar_active')
  @include('include.sidebar_links', [
    ...
    'appointments' => '', 'appointment' => '', 'payment' => 'active', 'payment_mode' => 'active', 'currency' => '', 'status' => '',
        ...
        <div class="row">
            <div class="col-md-3">
                    ...
                    <div class="input-group displayblock">
                        <input type="text" name="payment_id" class="form-control " id="column_filter_2"  onkeyup="searchDatatable(2)" placeholder="Search by Payment">
                    </div>
                </div>
            </div>     
            <div class="col-md-3">
                    ...
                    <div class="input-group displayblock">
                        <input type="email" name="email" class="form-control " id="column_filter_4"  onkeyup="searchDatatable(4)" placeholder="Search by email">                             
                    </div>
                </div>
            </div>   
            <!-- <div class="col-md-5">
                    ...
                    "render"        : function(result){
                        ...
                        var dropDownButton      =   ''+
                            ...
                            '<div class="btn-toolbarr">'+
                                ...
                                '<a href="'+adminListUrl+'/'+result.payment_id+'" class="btn btn-info btn-sm mr-1" data-toggle="tooltip" title="" data-original-title="Edit '+name+'">'+
