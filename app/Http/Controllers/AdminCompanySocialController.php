...
use App\Http\Requests\CompanySocialCreateRequest;
use App\Http\Requests\CompanySocialUpdateRequest;
...
class AdminCompanySocialController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(CompanySocialCreateRequest $request)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(CompanySocialUpdateRequest $request, $id)
    {
